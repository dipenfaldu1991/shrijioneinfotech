...
(function ($) {
    ...
    CRUMINA.initSwiper = function () {
        ...
        $('.swiper-container').each(function () {
            ...
            var $effect = ($t.data('effect')) ? $t.data('effect') : 'slide',
                ...
                $autoplay = ($t.data('autoplay')) ? parseInt($t.data('autoplay'), 10) : 4000,
	...
	jQuery(".js-rmessage-popup").on('click', function () {
        setTimeout(function() {  $('.rmessage-popup').addClass('open'); }, 300);
        return false;
    });
	...
	jQuery(".js-popup-rclose").on('click', function () {
         {  $('.search-popup').removeClass('open'); }
         {  $('.rmessage-popup').removeClass('open'); }
         {  $('.popup-gallery').removeClass('open'); }
        return false;
    });
